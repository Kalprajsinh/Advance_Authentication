...
function App() {
  ...
  return (
    ...
    <div className="flex items-center h-28 gap-4 pl-4">
      <div className="w-7 h-7 bg-violet-950 rounded-full content-center"><div className="w-5 h-5 bg-blue-950 rounded-full flex items-center justify-end"><div className="w-3 h-3 bg-indigo-950 rounded-full"></div></div></div>
      <h1 className="text-3xl font-bold text-white">Authentication</h1>
    </div>
    <div className="h-1/3 flex justify-center gap-5">
    <div className="pl-8 bg-black bg-opacity-40 w-3/4 text-base font-bold text-white rounded-lg p-5 font-mono">
    
    <div className='font-sans underline'>Backend Process</div>
    <br />
          <div>
          &gt; User Loggedin - false
          </div>
          ...
          <br /><br />
          <div className="text-sm text-blue-300 flex items-center gap-2 select-none">To see more backend process, please Login or Signup <p className='text-3xl'>→</p></div>
    </div>
